...
// Contract: Voting
// Source: Etherscan, mainnet 0x2e59A20f205bB85a89C53f1936454680651E618e (AppProxyUpgradeable) → implementation 0xf165148978Fa3cE74d76043f833463c340CFB704 (Voting)
...
export const Voting_ABI = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "objectionPhaseTime", type: "uint64" }],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "voter", type: "address" },
      { indexed: true, name: "assignedDelegate", type: "address" },
    ],
    name: "AssignDelegate",
    type: "event",
  },
  {
    ...
    inputs: [
      { indexed: true, name: "voter", type: "address" },
      { indexed: true, name: "unassignedDelegate", type: "address" },
    ],
    name: "UnassignDelegate",
    type: "event",
  },
