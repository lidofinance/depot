...
// Contract: Lido
// Source: Etherscan, mainnet 0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84 (AppProxyUpgradeable) → implementation 0x028271E30a695c0527A0C50cA30603feD004cDb0 (Lido)
...
export const Lido_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_depositsReserveTarget", type: "uint256" },
    ],
    name: "initialize",
    outputs: [],
    payable: true,
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "depositsReserveTarget", type: "uint256" }],
