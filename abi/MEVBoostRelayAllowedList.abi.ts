...
// Source: Etherscan, mainnet 0xF95f069F9AD107938F6ba802a3da87892298610E (Vyper_contract)

export const MEVBoostRelayAllowedList_ABI = [
  {
    name: "RelayAdded",
    inputs: [
  ...
  { stateMutability: "nonpayable", type: "constructor", inputs: [{ name: "owner", type: "address" }], outputs: [] },
  {
  ...
  { stateMutability: "nonpayable", type: "function", name: "dismiss_manager", inputs: [], outputs: [] },
  {
    stateMutability: "nonpayable",
    type: "function",
    name: "recover_erc20",
