...
// Source: Etherscan, mainnet 0xC1d0b3DE6792Bf6b4b37EccdcC24e45978Cfd2Eb (OssifiableProxy), proxy ABI
...
export const OssifiableProxy_ABI = [
  ...
  { inputs: [], name: "proxy__ossify", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
