...
// Source: Etherscan, mainnet 0x7FaDB6358950c5fAA66Cb5EB8eE5147De3df355a (HashConsensus)

export const HashConsensus_ABI = [
  {
    inputs: [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "fastLaneLengthSlots", type: "uint256" }],
  ...
  { inputs: [], name: "disableConsensus", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [],
    name: "getChainConfig",
    outputs: [
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "bytes32", name: "currentFrameConsensusReport", type: "bytes32" },
