export const Escrow_ABI = [
  {
    inputs: [
      ...
      { internalType: "contract IDualGovernance", name: "dualGovernance", type: "address" },
  ...
  { inputs: [{ internalType: "uint256", name: "size", type: "uint256" }], name: "InvalidBatchSize", type: "error" },
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: "Duration", name: "newMinAssetsLockDuration", type: "uint32" }],
  ...
  { inputs: [], name: "InvalidUnstETHIdsSequence", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "unstETHId", type: "uint256" },
      { internalType: "enum UnstETHRecordStatus", name: "status", type: "uint8" },
    ],
    name: "InvalidUnstETHStatus",
    type: "error",
  },
  {
    inputs: [{ internalType: "Timestamp", name: "lockDurationExpiresAt", type: "uint40" }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "ETHValue", name: "amount", type: "uint128" }],
    name: "ETHClaimed",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "SharesValue", name: "shares", type: "uint128" },
      { indexed: false, internalType: "ETHValue", name: "value", type: "uint128" },
    ],
    name: "ETHWithdrawn",
    type: "event",
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "Duration", name: "newAssetsLockDuration", type: "uint32" }],
    name: "MinAssetsLockDurationSet",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "Timestamp", name: "startedAt", type: "uint40" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "Duration", name: "rageQuitExtensionPeriodDuration", type: "uint32" },
      { indexed: false, internalType: "Duration", name: "rageQuitEthWithdrawalsDelay", type: "uint32" },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256[]", name: "unstETHIds", type: "uint256[]" },
      { indexed: false, internalType: "ETHValue", name: "totalAmountClaimed", type: "uint128" },
    ],
    name: "UnstETHClaimed",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "SharesValue[]", name: "finalizedShares", type: "uint128[]" },
      { indexed: false, internalType: "ETHValue[]", name: "finalizedAmount", type: "uint128[]" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256[]", name: "unstETHIds", type: "uint256[]" }],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "holder", type: "address" },
      { indexed: false, internalType: "uint256[]", name: "ids", type: "uint256[]" },
      { indexed: false, internalType: "SharesValue", name: "finalizedSharesIncrement", type: "uint128" },
      { indexed: false, internalType: "ETHValue", name: "finalizedAmountIncrement", type: "uint128" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: "uint256[]", name: "unstETHIds", type: "uint256[]" },
      { indexed: false, internalType: "ETHValue", name: "amountWithdrawn", type: "uint128" },
    ],
    name: "UnstETHWithdrawn",
    type: "event",
  },
  { anonymous: false, inputs: [], name: "WithdrawalsBatchesQueueClosed", type: "event" },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "boundaryUnstETHId", type: "uint256" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract IDualGovernance", name: "", type: "address" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract IEscrowBase", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "uint256", name: "maxUnstETHIdsCount", type: "uint256" }],
    name: "claimNextWithdrawalsBatch",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint256[]", name: "unstETHIds", type: "uint256[]" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "Duration", name: "minAssetsLockDuration", type: "uint32" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [{ internalType: "uint256[]", name: "unstETHIds", type: "uint256[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "Duration", name: "rageQuitEthWithdrawalsDelay", type: "uint32" },
          { internalType: "Duration", name: "rageQuitExtensionPeriodDuration", type: "uint32" },
          { internalType: "Timestamp", name: "rageQuitExtensionPeriodStartedAt", type: "uint40" },
          { internalType: "bool", name: "isRageQuitExtensionPeriodStarted", type: "bool" },
        ],
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "SharesValue", name: "totalStETHLockedShares", type: "uint128" },
          { internalType: "ETHValue", name: "totalStETHClaimedETH", type: "uint128" },
          { internalType: "SharesValue", name: "totalUnstETHUnfinalizedShares", type: "uint128" },
          { internalType: "ETHValue", name: "totalUnstETHFinalizedETH", type: "uint128" },
        ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "SharesValue", name: "stETHLockedShares", type: "uint128" },
          { internalType: "SharesValue", name: "unstETHLockedShares", type: "uint128" },
          { internalType: "Timestamp", name: "lastAssetsLockTimestamp", type: "uint40" },
        ],
  ...
  },
  {
    ...
    name: "lockStETH",
    outputs: [{ internalType: "uint256", name: "lockedStETHShares", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
  ...
  { inputs: [], name: "startRageQuitExtensionPeriod", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [],
    name: "unlockStETH",
    outputs: [{ internalType: "uint256", name: "unlockedStETHShares", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [],
    name: "unlockWstETH",
    outputs: [{ internalType: "uint256", name: "wstETHUnlocked", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
