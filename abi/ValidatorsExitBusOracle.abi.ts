...
// Source: Etherscan, mainnet 0x0De4Ea0184c2ad0BacA7183356Aea5B8d5Bf5c6e (OssifiableProxy) → implementation 0x2C3386b39db89eef0F362A3BE0C05a6811E809E3 (ValidatorsExitBusOracle)

export const ValidatorsExitBusOracle_ABI = [
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "exitDataIndex", type: "uint256" },
      { internalType: "uint256", name: "requestsCount", type: "uint256" },
    ],
    name: "ExitDataIndexOutOfRange",
    type: "error",
  },
  { inputs: [], name: "ExitHashAlreadySubmitted", type: "error" },
  { inputs: [], name: "ExitHashNotSubmitted", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "balanceEth", type: "uint256" },
      { internalType: "uint256", name: "remainingLimitEth", type: "uint256" },
    ],
  ...
  { inputs: [], name: "InvalidExitDataIndexSortOrder", type: "error" },
  { inputs: [], name: "InvalidMaxEBWeight", type: "error" },
  { inputs: [], name: "InvalidModuleId", type: "error" },
  { inputs: [{ internalType: "uint256", name: "index", type: "uint256" }], name: "InvalidPublicKey", type: "error" },
  { inputs: [], name: "InvalidRequestsDataLength", type: "error" },
  { inputs: [], name: "InvalidRequestsDataSortOrder", type: "error" },
  { inputs: [], name: "InvalidRetrievedKeyLength", type: "error" },
  ...
  { inputs: [], name: "RequestsAlreadyDelivered", type: "error" },
  { inputs: [], name: "RequestsNotDelivered", type: "error" },
  ...
  { inputs: [], name: "TooLargeFrameDuration", type: "error" },
  { inputs: [], name: "TooLargeItemsPerFrame", type: "error" },
  { inputs: [], name: "TooLargeMaxLimit", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "requestsCount", type: "uint256" },
      { internalType: "uint256", name: "maxRequestsPerReport", type: "uint256" },
    ],
  ...
  { inputs: [], name: "UnexpectedRequestsDataLength", type: "error" },
  { inputs: [], name: "UnexpectedWCType", type: "error" },
  {
  ...
  { inputs: [{ internalType: "string", name: "name", type: "string" }], name: "ZeroArgument", type: "error" },
  { inputs: [], name: "ZeroFrameDuration", type: "error" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "maxExitBalanceEth", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "balancePerFrameEth", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "frameDurationInSec", type: "uint256" },
    ],
    name: "ExitBalanceLimitSet",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "bytes32", name: "exitRequestsHash", type: "bytes32" }],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint256", name: "refSlot", type: "uint256" },
      { indexed: false, internalType: "bytes32", name: "hash", type: "bytes32" },
      { indexed: false, internalType: "uint256", name: "processingDeadlineTime", type: "uint256" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "maxValidatorsPerReport", type: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "uint256", name: "validatorIndex", type: "uint256" },
      { indexed: false, internalType: "bytes", name: "validatorPubkey", type: "bytes" },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint256", name: "refSlot", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "requestsProcessed", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "requestsCount", type: "uint256" },
    ],
  ...
  {
    inputs: [],
    name: "DATA_FORMAT_LIST_WITH_KEY_INDEX",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "MAX_EFFECTIVE_BALANCE_WEIGHT_WC_TYPE_01",
  ...
  {
    inputs: [],
    name: "MAX_EFFECTIVE_BALANCE_WEIGHT_WC_TYPE_02",
    outputs: [{ internalType: "uint16", name: "", type: "uint16" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "maxValidatorsPerReport", type: "uint256" },
      { internalType: "uint256", name: "maxExitBalanceEth", type: "uint256" },
      { internalType: "uint256", name: "balancePerFrameEth", type: "uint256" },
      { internalType: "uint256", name: "frameDurationInSec", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "bytes32", name: "exitRequestsHash", type: "bytes32" }],
    name: "getDeliveryTimestamp",
    outputs: [{ internalType: "uint256", name: "deliveryDateTimestamp", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "balancePerFrameEth", type: "uint256" },
      { internalType: "uint256", name: "frameDurationInSec", type: "uint256" },
      { internalType: "uint256", name: "prevExitBalanceEth", type: "uint256" },
      { internalType: "uint256", name: "currentExitBalanceEth", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "bool", name: "dataSubmitted", type: "bool" },
          { internalType: "uint256", name: "dataFormat", type: "uint256" },
          { internalType: "uint256", name: "requestsCount", type: "uint256" },
          { internalType: "uint256", name: "requestsSubmitted", type: "uint256" },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256[]", name: "exitDataIndexes", type: "uint256[]" },
  ...
  {
    inputs: [
      { internalType: "bytes", name: "exitRequests", type: "bytes" },
      { internalType: "uint256", name: "dataFormat", type: "uint256" },
      { internalType: "uint256", name: "index", type: "uint256" },
    ],
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "nodeOpId", type: "uint256" },
      { internalType: "uint256", name: "moduleId", type: "uint256" },
      { internalType: "uint256", name: "valIndex", type: "uint256" },
    ],
