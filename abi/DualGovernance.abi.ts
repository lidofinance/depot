...
// Source: Etherscan, mainnet 0xC1db28B3301331277e307FDCfF8DE28242A4486E (DualGovernance)
...
export const DualGovernance_ABI = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "contract IResealManager", name: "resealManager", type: "address" },
          { internalType: "contract IDualGovernanceConfigProvider", name: "configProvider", type: "address" },
        ],
      ...
      },
      {
        components: [
          ...
          { internalType: "contract IWithdrawalQueue", name: "withdrawalQueue", type: "address" },
        ],
      ...
      {
        components: [
          { internalType: "uint256", name: "minWithdrawalsBatchSize", type: "uint256" },
          { internalType: "Duration", name: "minTiebreakerActivationTimeout", type: "uint32" },
          { internalType: "Duration", name: "maxTiebreakerActivationTimeout", type: "uint32" },
          { internalType: "uint256", name: "maxSealableWithdrawalBlockersCount", type: "uint256" },
          { internalType: "Duration", name: "maxMinAssetsLockDuration", type: "uint32" },
        ],
  ...
  {
    inputs: [{ internalType: "contract IDualGovernanceConfigProvider", name: "configProvider", type: "address" }],
    name: "InvalidConfigProvider",
    type: "error",
  },
  { inputs: [{ internalType: "address", name: "executor", type: "address" }], name: "InvalidExecutor", type: "error" },
  {
    inputs: [{ internalType: "Duration", name: "minAssetsLockDuration", type: "uint32" }],
  ...
  {
    inputs: [
      { internalType: "Duration", name: "rageQuitEthWithdrawalsMinDelay", type: "uint32" },
      { internalType: "Duration", name: "rageQuitEthWithdrawalsMaxDelay", type: "uint32" },
    ],
  ...
  {
    inputs: [
      { internalType: "PercentD16", name: "firstSealRageQuitSupport", type: "uint128" },
      { internalType: "PercentD16", name: "secondSealRageQuitSupport", type: "uint128" },
    ],
  ...
  {
    inputs: [{ internalType: "contract IResealManager", name: "resealManager", type: "address" }],
    name: "InvalidResealManager",
    type: "error",
  },
  { inputs: [{ internalType: "address", name: "sealable", type: "address" }], name: "InvalidSealable", type: "error" },
  {
    inputs: [{ internalType: "PercentD16", name: "secondSealRageQuitSupport", type: "uint128" }],
  ...
  {
    inputs: [
      { internalType: "Duration", name: "vetoSignallingMinDuration", type: "uint32" },
      { internalType: "Duration", name: "vetoSignallingMaxDuration", type: "uint32" },
    ],
  ...
  { anonymous: false, inputs: [], name: "CancelAllPendingProposalsExecuted", type: "event" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "enum State", name: "from", type: "uint8" },
      { indexed: true, internalType: "enum State", name: "to", type: "uint8" },
      {
        components: [
          ...
          { internalType: "Timestamp", name: "vetoSignallingActivatedAt", type: "uint40" },
          { internalType: "contract ISignallingEscrow", name: "signallingEscrow", type: "address" },
          { internalType: "uint8", name: "rageQuitRound", type: "uint8" },
          { internalType: "Timestamp", name: "vetoSignallingReactivationTime", type: "uint40" },
          { internalType: "Timestamp", name: "normalOrVetoCooldownExitedAt", type: "uint40" },
          { internalType: "contract IRageQuitEscrow", name: "rageQuitEscrow", type: "address" },
          { internalType: "contract IDualGovernanceConfigProvider", name: "configProvider", type: "address" },
        ],
        indexed: false,
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "contract IEscrowBase", name: "escrowMasterCopy", type: "address" }],
    name: "EscrowMasterCopyDeployed",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: "contract ISignallingEscrow", name: "escrow", type: "address" }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "proposalsCanceller", type: "address" }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "resealCommittee", type: "address" }],
    name: "ResealCommitteeSet",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "contract IResealManager", name: "resealManager", type: "address" }],
    name: "ResealManagerSet",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "sealable", type: "address" }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "Duration", name: "newTiebreakerActivationTimeout", type: "uint32" }],
    name: "TiebreakerActivationTimeoutSet",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "newTiebreakerCommittee", type: "address" }],
  ...
  { inputs: [], name: "activateNextState", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [{ internalType: "address", name: "sealableWithdrawalBlocker", type: "address" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract IDualGovernanceConfigProvider", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "Timestamp", name: "persistedStateEnteredAt", type: "uint40" },
          { internalType: "Timestamp", name: "vetoSignallingActivatedAt", type: "uint40" },
          { internalType: "Timestamp", name: "vetoSignallingReactivationTime", type: "uint40" },
          { internalType: "Timestamp", name: "normalOrVetoCooldownExitedAt", type: "uint40" },
          { internalType: "uint256", name: "rageQuitRound", type: "uint256" },
          { internalType: "Duration", name: "vetoSignallingDuration", type: "uint32" },
        ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "Duration", name: "tiebreakerActivationTimeout", type: "uint32" },
          { internalType: "address[]", name: "sealableWithdrawalBlockers", type: "address[]" },
        ],
  ...
  {
    inputs: [{ internalType: "contract IDualGovernanceConfigProvider", name: "newConfigProvider", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "newProposalsCanceller", type: "address" }],
  ...
  {
    inputs: [{ internalType: "contract IResealManager", name: "newResealManager", type: "address" }],
  ...
  {
    inputs: [{ internalType: "Duration", name: "newTiebreakerActivationTimeout", type: "uint32" }],
  ...
  {
    inputs: [{ internalType: "address", name: "newTiebreakerCommittee", type: "address" }],
