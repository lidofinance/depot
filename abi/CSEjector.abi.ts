...
// Contract: Ejector
// Source: Etherscan, mainnet 0x610B517D380f287c239C93F8eF6FfBd567AA4bA5 (Ejector)

export const CSEjector_ABI = [
  {
    inputs: [
  ...
  { inputs: [], name: "DuplicateKeyIndex", type: "error" },
  { inputs: [], name: "NodeOperatorDoesNotExist", type: "error" },
  { inputs: [], name: "NothingToEject", type: "error" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "stakingModuleId", type: "uint256" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract ITriggerableWithdrawalsGateway", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
