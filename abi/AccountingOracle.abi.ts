...
// Source: Etherscan, mainnet 0x852deD011285fe67063a08005c71a85690503Cee (OssifiableProxy) → implementation 0xe4f03D1107d1905B6F2A28FCb6Af221E0CE19136 (AccountingOracle)

export const AccountingOracle_ABI = [
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint256", name: "refSlot", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "processedItemsCount", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "itemsCount", type: "uint256" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "consensusVersion", type: "uint256" }],
    name: "finalizeUpgrade_v5",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "refSlot", type: "uint256" },
      { internalType: "uint256", name: "refSlotTimestamp", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    inputs: [
      {
        components: [
          { internalType: "uint256", name: "consensusVersion", type: "uint256" },
          { internalType: "uint256", name: "refSlot", type: "uint256" },
          { internalType: "uint256", name: "clValidatorsBalanceGwei", type: "uint256" },
          { internalType: "uint256", name: "clPendingBalanceGwei", type: "uint256" },
          { internalType: "uint256[]", name: "stakingModuleIdsWithNewlyExitedValidators", type: "uint256[]" },
          { internalType: "uint256[]", name: "numExitedValidatorsByStakingModule", type: "uint256[]" },
          { internalType: "uint256[]", name: "stakingModuleIdsWithUpdatedBalance", type: "uint256[]" },
          { internalType: "uint256[]", name: "validatorBalancesGweiByStakingModule", type: "uint256[]" },
          ...
          { internalType: "uint256[]", name: "withdrawalFinalizationBatches", type: "uint256[]" },
          { internalType: "uint256", name: "simulatedShareRate", type: "uint256" },
          { internalType: "bool", name: "isBunkerMode", type: "bool" },
          { internalType: "bytes32", name: "vaultsDataTreeRoot", type: "bytes32" },
          { internalType: "string", name: "vaultsDataTreeCid", type: "string" },
          { internalType: "uint256", name: "extraDataFormat", type: "uint256" },
          { internalType: "bytes32", name: "extraDataHash", type: "bytes32" },
          { internalType: "uint256", name: "extraDataItemsCount", type: "uint256" },
        ],
  ...
  { inputs: [], name: "submitReportExtraDataEmpty", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
