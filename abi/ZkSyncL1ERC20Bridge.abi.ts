...
// Source: Etherscan, mainnet 0x41527B2d03844dB6b0945f25702cB958b6d55989 (OssifiableProxy) → implementation 0x43a66B32c9AdcA1A59b273E69b61Da5197c21cCd (L1ERC20Bridge)

export const ZkSyncL1ERC20Bridge_ABI = [
  ...
  { inputs: [], name: "disableDeposits", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [], name: "disableWithdrawals", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [], name: "enableDeposits", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [], name: "enableWithdrawals", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [
      { internalType: "uint256", name: "_l2BlockNumber", type: "uint256" },
      { internalType: "uint256", name: "_l2MessageIndex", type: "uint256" },
    ...
    inputs: [
      { internalType: "bytes[]", name: "_factoryDeps", type: "bytes[]" },
      {
        components: [
          ...
          { internalType: "address", name: "_zkSync", type: "address" },
        ],
        internalType: "struct IL1ERC20Bridge.InitializeAddressesParams",
        name: "addresses",
        type: "tuple",
      },
      { internalType: "uint256", name: "_deployBridgeImplementationFee", type: "uint256" },
      { internalType: "uint256", name: "_deployBridgeProxyFee", type: "uint256" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "payable",
  ...
  },
  {
    ...
    name: "l2TokenAddress",
    outputs: [{ internalType: "address", name: "l2TokenAddr", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [],
    name: "zkSync",
    outputs: [{ internalType: "contract IZkSync", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
] as const;
