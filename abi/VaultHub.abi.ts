...
// Contract: VaultHub
// Source: Etherscan, mainnet 0x1d201BE093d847f6446530Efb0E8Fb426d176709 (OssifiableProxy) → implementation 0x6330fE7756FBE8649adfb9A541d61C5edB8B4D70 (VaultHub)

export const VaultHub_ABI = [
  {
    inputs: [
      { internalType: "contract ILidoLocator", name: "_locator", type: "address" },
      { internalType: "contract ILido", name: "_lido", type: "address" },
      { internalType: "contract IHashConsensus", name: "_consensusContract", type: "address" },
      { internalType: "uint256", name: "_maxRelativeShareLimitBP", type: "uint256" },
    ],
  ...
  { inputs: [{ internalType: "address", name: "vault", type: "address" }], name: "NotConnectedToHub", type: "error" },
  { inputs: [], name: "NotInitializing", type: "error" },
  { inputs: [{ internalType: "address", name: "vault", type: "address" }], name: "PDGNotDepositor", type: "error" },
  ...
  { inputs: [{ internalType: "address", name: "vault", type: "address" }], name: "VaultOssified", type: "error" },
  { inputs: [{ internalType: "address", name: "vault", type: "address" }], name: "VaultReportStale", type: "error" },
  ...
  { inputs: [], name: "ZeroPauseDuration", type: "error" },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "vaultDonor", type: "address" },
      { indexed: true, internalType: "address", name: "vaultAcceptor", type: "address" },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "bool", name: "pauseIntent", type: "bool" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "bytes", name: "pubkeys", type: "bytes" },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "uint256", name: "shareLimit", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "reserveRatioBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "forcedRebalanceThresholdBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "infraFeeBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "liquidityFeeBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "reservationFeeBP", type: "uint256" },
    ],
    name: "VaultConnected",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "uint256", name: "slashingReserve", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "uint256", name: "preInfraFeeBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "preLiquidityFeeBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "preReservationFeeBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "infraFeeBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "liquidityFeeBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "reservationFeeBP", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "int256", name: "inOutDelta", type: "int256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "uint256", name: "redemptionShares", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "vault", type: "address" },
      { indexed: false, internalType: "uint256", name: "reportTimestamp", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "reportTotalValue", type: "uint256" },
      { indexed: false, internalType: "int256", name: "reportInOutDelta", type: "int256" },
      { indexed: false, internalType: "uint256", name: "reportCumulativeLidoFees", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "reportLiabilityShares", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "reportMaxLiabilityShares", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "reportSlashingReserve", type: "uint256" },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract IHashConsensus", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_reportTotalValue", type: "uint256" },
      { internalType: "int256", name: "_reportInOutDelta", type: "int256" },
      { internalType: "uint256", name: "_reportCumulativeLidoFees", type: "uint256" },
      { internalType: "uint256", name: "_reportLiabilityShares", type: "uint256" },
      { internalType: "uint256", name: "_reportMaxLiabilityShares", type: "uint256" },
      { internalType: "uint256", name: "_reportSlashingReserve", type: "uint256" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_amountOfShares", type: "uint256" }],
  ...
  {
    inputs: [
      { internalType: "address", name: "_badDebtVault", type: "address" },
      { internalType: "uint256", name: "_maxSharesToInternalize", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_vault", type: "address" },
      { internalType: "uint256", name: "_liabilitySharesTarget", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_badDebtVault", type: "address" },
      { internalType: "address", name: "_vaultAcceptor", type: "address" },
      { internalType: "uint256", name: "_maxSharesToSocialize", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_vault", type: "address" },
      { internalType: "int256", name: "_deltaValue", type: "int256" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_vault", type: "address" },
      { internalType: "uint256", name: "_shareLimit", type: "uint256" },
      { internalType: "uint256", name: "_reserveRatioBP", type: "uint256" },
      { internalType: "uint256", name: "_forcedRebalanceThresholdBP", type: "uint256" },
      { internalType: "uint256", name: "_infraFeeBP", type: "uint256" },
      { internalType: "uint256", name: "_liquidityFeeBP", type: "uint256" },
      { internalType: "uint256", name: "_reservationFeeBP", type: "uint256" },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint48", name: "disconnectInitiatedTs", type: "uint48" },
          { internalType: "uint16", name: "reserveRatioBP", type: "uint16" },
          { internalType: "uint16", name: "forcedRebalanceThresholdBP", type: "uint16" },
          ...
          { internalType: "bool", name: "beaconChainDepositsPauseIntent", type: "bool" },
        ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint96", name: "maxLiabilityShares", type: "uint96" },
          { internalType: "uint96", name: "liabilityShares", type: "uint96" },
          {
            components: [
              { internalType: "int104", name: "value", type: "int104" },
              { internalType: "int104", name: "valueOnRefSlot", type: "int104" },
              { internalType: "uint48", name: "refSlot", type: "uint48" },
            ],
            internalType: "struct DoubleRefSlotCache.Int104WithCache[2]",
            name: "inOutDelta",
            type: "tuple[2]",
          },
          { internalType: "uint128", name: "minimalReserve", type: "uint128" },
          { internalType: "uint128", name: "redemptionShares", type: "uint128" },
          { internalType: "uint128", name: "cumulativeLidoFees", type: "uint128" },
          { internalType: "uint128", name: "settledLidoFees", type: "uint128" },
        ],
