...
// Contract: LazyOracle
// Source: Etherscan, mainnet 0x5DB427080200c235F2Ae8Cd17A7be87921f7AD6c (OssifiableProxy) → implementation 0x96c9a897D116ef660086d3aA67b3af653324aB37 (LazyOracle)

export const LazyOracle_ABI = [
  {
    inputs: [{ internalType: "address", name: "_lidoLocator", type: "address" }],
  ...
  { inputs: [], name: "InOutDeltaCacheIsOverwritten", type: "error" },
  { inputs: [], name: "InvalidInitialization", type: "error" },
  { inputs: [], name: "InvalidMaxLiabilityShares", type: "error" },
  ...
  { inputs: [], name: "TotalValueTooLarge", type: "error" },
  { inputs: [], name: "UnderflowInTotalValueCalculation", type: "error" },
  { inputs: [], name: "VaultReportIsFreshEnough", type: "error" },
  {
    anonymous: false,
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "totalValueReminder", type: "uint256" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "quarantinePeriod", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "maxRewardRatioBP", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "maxLidoFeeRatePerSecond", type: "uint256" },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "aggregatedBalance", type: "uint256" },
          { internalType: "int256", name: "inOutDelta", type: "int256" },
          { internalType: "bytes32", name: "withdrawalCredentials", type: "bytes32" },
          { internalType: "uint256", name: "liabilityShares", type: "uint256" },
          { internalType: "uint256", name: "maxLiabilityShares", type: "uint256" },
          { internalType: "uint256", name: "mintableStETH", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_quarantinePeriod", type: "uint256" },
      { internalType: "uint256", name: "_maxRewardRatioBP", type: "uint256" },
      { internalType: "uint256", name: "_maxLidoFeeRatePerSecond", type: "uint256" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_vaultsDataTimestamp", type: "uint256" },
      { internalType: "uint256", name: "_vaultsDataRefSlot", type: "uint256" },
      { internalType: "bytes32", name: "_vaultsDataTreeRoot", type: "bytes32" },
      { internalType: "string", name: "_vaultsDataReportCid", type: "string" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_cumulativeLidoFees", type: "uint256" },
      { internalType: "uint256", name: "_liabilityShares", type: "uint256" },
      { internalType: "uint256", name: "_maxLiabilityShares", type: "uint256" },
      { internalType: "uint256", name: "_slashingReserve", type: "uint256" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "pendingTotalValueIncrease", type: "uint256" },
          { internalType: "uint256", name: "startTimestamp", type: "uint256" },
          { internalType: "uint256", name: "endTimestamp", type: "uint256" },
          { internalType: "uint256", name: "totalValueRemainder", type: "uint256" },
        ],
