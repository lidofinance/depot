export const StakingRouter_ABI = [
  {
    inputs: [{ internalType: "address", name: "_depositContract", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "firstArrayLength", type: "uint256" },
      { internalType: "uint256", name: "secondArrayLength", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "currentNodeOpStuckValidatorsCount", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint256", name: "stakingModuleId", type: "uint256" },
      { indexed: false, internalType: "enum StakingRouter.StakingModuleStatus", name: "status", type: "uint8" },
      { indexed: false, internalType: "address", name: "setBy", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256[]", name: "_priorityExitShareThresholds", type: "uint256[]" },
      { internalType: "uint256[]", name: "_maxDepositsPerBlock", type: "uint256[]" },
      { internalType: "uint256[]", name: "_minDepositBlockDistances", type: "uint256[]" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_depositsCount", type: "uint256" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256[]", name: "stakingModuleIds", type: "uint256[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: "enum StakingRouter.StakingModuleStatus", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_stakingModuleId", type: "uint256" },
      { internalType: "enum StakingRouter.StakingModuleStatus", name: "_status", type: "uint8" },
    ],
    ...
    inputs: [
      ...
      { internalType: "bool", name: "_triggerUpdateFinish", type: "bool" },
      {
        components: [
          ...
          { internalType: "uint256", name: "currentNodeOperatorStuckValidatorsCount", type: "uint256" },
          ...
          { internalType: "uint256", name: "newNodeOperatorStuckValidatorsCount", type: "uint256" },
        ],
