...
// Contract: Finance
// Source: Etherscan, mainnet 0xB9E5CBB9CA5b0d659238807E84D0176930753d86 (AppProxyUpgradeable) → implementation 0x836835289A2E81B66AE5d95b7c8dBC0480dCf9da (Finance)

export const Finance_ABI = [
  {
    constant: true,
    inputs: [],
    name: "hasInitialized",
  ...
  { payable: true, stateMutability: "payable", type: "fallback" },
  {
    anonymous: false,
    inputs: [
      { indexed: true, name: "periodId", type: "uint64" },
      { indexed: false, name: "periodStarts", type: "uint64" },
      { indexed: false, name: "periodEnds", type: "uint64" },
    ],
    name: "NewPeriod",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "hasBudget", type: "bool" },
    ],
    name: "SetBudget",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "maxExecutions", type: "uint64" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "incoming", type: "bool" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "newDuration", type: "uint64" }],
    name: "ChangePeriodDuration",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "paymentId", type: "uint256" }],
    name: "PaymentFailure",
    type: "event",
  },
  {
