export const NodeOperatorsRegistry_ABI = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "stuckPenaltyDelay", type: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "stuckValidatorsCount", type: "uint256" },
      { indexed: false, name: "refundedValidatorsCount", type: "uint256" },
      { indexed: false, name: "stuckPenaltyEndTimestamp", type: "uint256" },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, name: "recipientAddress", type: "address" },
      { indexed: false, name: "sharesPenalizedAmount", type: "uint256" },
    ],
