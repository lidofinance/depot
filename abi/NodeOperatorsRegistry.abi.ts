...
// Source: Etherscan, mainnet 0x55032650b14df07b85bF18A3a3eC8E0Af2e028d5 (AppProxyUpgradeable) → implementation 0x6828b023e737f96B168aCd0b5c6351971a4F81aE (NodeOperatorsRegistry)

export const NodeOperatorsRegistry_ABI = [
  {
    constant: true,
    inputs: [],
    name: "hasInitialized",
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "name", type: "string" },
      { indexed: false, name: "rewardAddress", type: "address" },
      { indexed: false, name: "stakingLimit", type: "uint64" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "totalKeysTrimmed", type: "uint64" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "keysOpIndex", type: "uint256" }],
    name: "KeysOpIndexSet",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "moduleType", type: "bytes32" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, name: "rewardAddress", type: "address" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "locatorAddress", type: "address" }],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "approvedValidatorsCount", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "depositedValidatorsCount", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "exitedValidatorsCount", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "totalValidatorsCount", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "eligibleToExitInSec", type: "uint256" },
      { indexed: false, name: "proofSlotTimestamp", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "nodeOperatorId", type: "uint256" },
      { indexed: false, name: "publicKey", type: "bytes" },
      { indexed: false, name: "withdrawalRequestPaidFee", type: "uint256" },
      { indexed: false, name: "exitType", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "reportingWindow", type: "uint256" },
    ],
