...
// Contract: FeeOracle
// Source: Etherscan, mainnet 0x4D4074628678Bd302921c20573EEa1ed38DdF7FB (OssifiableProxy) → implementation 0xecE6e0Cde61078F76b66Ef0C338a6875E5D01F79 (FeeOracle)

export const CSFeeOracle_ABI = [
  {
    inputs: [
      { internalType: "address", name: "feeDistributor", type: "address" },
      { internalType: "address", name: "strikes", type: "address" },
  ...
  { inputs: [], name: "InvalidContractVersion", type: "error" },
  ...
  { inputs: [], name: "VersionCannotBeZero", type: "error" },
  ...
  { inputs: [], name: "ZeroStrikesAddress", type: "error" },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    inputs: [],
    name: "STRIKES",
    outputs: [{ internalType: "contract IValidatorStrikes", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "string", name: "treeCid", type: "string" },
          { internalType: "string", name: "logCid", type: "string" },
          { internalType: "uint256", name: "distributed", type: "uint256" },
          { internalType: "uint256", name: "rebate", type: "uint256" },
          { internalType: "bytes32", name: "strikesTreeRoot", type: "bytes32" },
          { internalType: "string", name: "strikesTreeCid", type: "string" },
        ],
