...
// Source: Etherscan, mainnet 0x889edC2eDab5f40e902b864aD4d7AdE8E412F9B1 (OssifiableProxy) → implementation 0xE42C659Dc09109566720EA8b2De186c2Be7D94D9 (WithdrawalQueueERC721)

export const WithdrawalQueue_ABI = [
  {
    inputs: [
  ...
  { inputs: [{ internalType: "uint256", name: "_hint", type: "uint256" }], name: "InvalidHint", type: "error" },
  { inputs: [{ internalType: "address", name: "", type: "address" }], name: "InvalidOwnerAddress", type: "error" },
  ...
  { inputs: [{ internalType: "address", name: "sender", type: "address" }], name: "NotOwnerOrApproved", type: "error" },
  {
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "nftDescriptorAddress", type: "address" }],
