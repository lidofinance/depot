...
// Contract: VettedGate
// Source: Etherscan, mainnet 0xB314D4A76C457c93150d308787939063F4Cc67E0 (OssifiableProxy) → implementation 0x66ADb8b3F58d3DFdF6bAdB595E41f19e947E5c14 (VettedGate)

export const VettedGate_ABI = [
  {
  ...
  { inputs: [], name: "AlreadyConsumed", type: "error" },
  ...
  { inputs: [], name: "NotAllowedToClaim", type: "error" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "bytes32", name: "treeRoot", type: "bytes32" },
      { indexed: false, internalType: "string", name: "treeCid", type: "string" },
    ],
    name: "TreeSet",
    type: "event",
  },
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "treeRoot_", type: "bytes32" },
      { internalType: "string", name: "treeCid_", type: "string" },
    ],
    name: "setTreeParams",
    outputs: [],
    stateMutability: "nonpayable",
