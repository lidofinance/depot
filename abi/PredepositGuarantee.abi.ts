...
// Source: Etherscan, mainnet 0xF4bF42c6D6A0E38825785048124DBAD6c9eaaac3 (OssifiableProxy) → implementation 0xE78717192C45736DF0E4be55c0219Ee7f9aDdd0D (PredepositGuarantee)

export const PredepositGuarantee_ABI = [
  {
    inputs: [
      { internalType: "bytes4", name: "_genesisForkVersion", type: "bytes4" },
      { internalType: "GIndex", name: "_gIFirstValidator", type: "bytes32" },
      { internalType: "GIndex", name: "_gIFirstValidatorAfterChange", type: "bytes32" },
      { internalType: "uint64", name: "_pivotSlot", type: "uint64" },
    ],
  ...
  { inputs: [], name: "ArrayLengthsNotMatch", type: "error" },
  { inputs: [], name: "CompensateFailed", type: "error" },
  { inputs: [], name: "EmptyDeposits", type: "error" },
  { inputs: [], name: "IndexOutOfRange", type: "error" },
  { inputs: [], name: "InputHasInfinityPoints", type: "error" },
  {
    inputs: [{ internalType: "enum BLS12_381.Component", name: "component", type: "uint8" }],
  ...
  { inputs: [], name: "InvalidDepositYLength", type: "error" },
  ...
  { inputs: [{ internalType: "uint256", name: "locked", type: "uint256" }], name: "LockedIsNotZero", type: "error" },
  ...
  { inputs: [], name: "NotGuarantor", type: "error" },
  { inputs: [], name: "NotInitializing", type: "error" },
  { inputs: [], name: "NotStakingVaultOwner", type: "error" },
  ...
  { inputs: [], name: "SameDepositor", type: "error" },
  { inputs: [], name: "SameGuarantor", type: "error" },
  {
    inputs: [
      { internalType: "bytes", name: "validatorPubkey", type: "bytes" },
      { internalType: "enum IPredepositGuarantee.ValidatorStage", name: "stage", type: "uint8" },
  ...
  {
    inputs: [{ internalType: "bytes", name: "validatorPubkey", type: "bytes" }],
  ...
  { inputs: [], name: "WithdrawalCredentialsMatch", type: "error" },
  {
    inputs: [{ internalType: "bytes32", name: "withdrawalCredentials", type: "bytes32" }],
    name: "WithdrawalCredentialsMisformed",
    type: "error",
  },
  {
    inputs: [
      { internalType: "address", name: "stakingVault", type: "address" },
      { internalType: "address", name: "withdrawalCredentialsAddress", type: "address" },
    ],
  ...
  { inputs: [], name: "ZeroPauseDuration", type: "error" },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint128", name: "total", type: "uint128" },
      { indexed: false, internalType: "uint128", name: "locked", type: "uint128" },
    ],
    name: "BalanceLocked",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "prevDepositor", type: "address" },
    ],
    name: "DepositorSet",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "nodeOperator", type: "address" },
      { indexed: true, internalType: "address", name: "newGuarantor", type: "address" },
      { indexed: true, internalType: "address", name: "prevGuarantor", type: "address" },
    ],
    name: "GuarantorSet",
    type: "event",
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "bytes", name: "validatorPubkey", type: "bytes" },
      { indexed: true, internalType: "address", name: "nodeOperator", type: "address" },
      { indexed: true, internalType: "address", name: "stakingVault", type: "address" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "nodeOperator", type: "address" },
      { indexed: true, internalType: "bytes", name: "validatorPubkey", type: "bytes" },
      { indexed: false, internalType: "uint256", name: "guaranteeTotal", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "guaranteeLocked", type: "uint256" },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "claimedEther", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [{ internalType: "address", name: "_guarantor", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_defaultAdmin", type: "address" }],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "contract IStakingVault", name: "_vault", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "contract IStakingVault", name: "_stakingVault", type: "address" },
      {
        components: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "_invalidWithdrawalCredentials", type: "bytes32" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "_newDepositor", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_newGuarantor", type: "address" }],
