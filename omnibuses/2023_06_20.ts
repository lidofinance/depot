...
const gasSupply_stEth_registry = "0x49d1363016aA899bba09ae972a1BF200dDf8C55F";
...
const reWARDS_stETH_registry = "0x48c4929630099b217136b64089E8543dB0E5163a";
...
const AllowedRecipientsRegistryInterface = AllowedRecipientsRegistry__factory.createInterface();

export default new Omnibus({
  version: "v2",
  network: "mainnet",
  launch: "2023-06-20",
  payload: ({ actions, contracts, addresses }) => [
    // I. Apply Insurance
    [
      "Transfer 13.45978634 stETH from Insurance fund to Agent",
      actions.agent.forward([
        addresses.insuranceFund,
        contracts.insuranceFund.interface.encodeFunctionData("transferERC20", [
          addresses.lido,
          addresses.agent,
    ...
    [
      ...
      actions.agent.forward([
        addresses.lido,
        contracts.lido.interface.encodeFunctionData("approve", [
          addresses.burner,
          INSURANCE_STETH_AMOUNT,
        ]),
      ]),
    ...
    [
      ...
      actions.agent.forward([
        addresses.burner,
        contracts.burner.interface.encodeFunctionData("grantRole", [
    ...
    [
      ...
      actions.agent.forward([
        addresses.burner,
        contracts.burner.interface.encodeFunctionData("requestBurnMyStETHForCover", [
          INSURANCE_STETH_AMOUNT,
        ]),
      ]),
    ],
    [
      ...
      actions.agent.forward([
        addresses.burner,
        contracts.burner.interface.encodeFunctionData("renounceRole", [
          REQUEST_BURN_MY_STETH_ROLE,
          addresses.agent,
        ]),
      ]),
    ...
    [
      ...
      actions.easyTrack.addEvmScriptFactory({
        factory: gasSupply_stETH_topup_factory,
        permissions: [
          {
            address: addresses.finance,
            fragment: contracts.finance.interface.getFunction("newImmediatePayment"),
          },
          {
            address: gasSupply_stEth_registry,
            fragment: AllowedRecipientsRegistryInterface.getFunction("updateSpentAmount"),
          },
        ],
      }),
    ],
    [
      ...
      actions.easyTrack.addEvmScriptFactory({
        ...
        permissions: [
          {
            address: gasSupply_stEth_registry,
            fragment: AllowedRecipientsRegistryInterface.getFunction("addRecipient"),
          },
        ],
      }),
    ],
    [
      ...
      actions.easyTrack.addEvmScriptFactory({
        ...
        permissions: [
          {
            address: gasSupply_stEth_registry,
            fragment: AllowedRecipientsRegistryInterface.getFunction("removeRecipient"),
          },
        ],
      }),
    ],
    ...
    [
      ...
      actions.easyTrack.addEvmScriptFactory({
        ...
        permissions: [
          ...
          {
            address: reWARDS_stETH_registry,
            fragment: AllowedRecipientsRegistryInterface.getFunction("updateSpentAmount"),
          },
        ],
      }),
    ...
    [
      ...
      actions.acl.createPermission({
        entity: addresses.voting,
        targetApp: addresses.nodeOperatorsRegistry,
        permission: "MANAGE_NODE_OPERATOR_ROLE",
        manager: addresses.voting,
      }),
    ],
    [
