...
export default omnibuses.create({
  network: 'mainnet',
  description,
  // launchedOn: 123456, // Launch block should be set only if omnibus was successfully launched.
  // voteId: 000, // Vote ID should be set only if omnibus is already started.
  // executedOn: 123456,  // Execution block should be set only if vote is passed and omnibus was successfully executed.
