...
export class ContractInfoInMemoryCache implements ContractInfoCache {
  ...
  get(chainId: ChainId, address: Address) {
    return Promise.resolve(this.data[chainId.toString()]?.[address] ?? null)
  }

  set(chainId: ChainId, address: Address, contractInfo: ContractInfo) {
