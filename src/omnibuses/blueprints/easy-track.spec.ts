...
describe('EVM script factories', () => {
  ...
  it('removeEvmScriptFactory works as expected', () => {
    const mockContracts = {
  ...
  it('addEvmScriptFactory works as expected', () => {
    const mockContracts = {
  ...
  it('addTopUpEvmScriptFactory works as expected', () => {
    const mockContracts = {
      easyTrack: { addEVMScriptFactory: '0xaddEVMScriptFactory' },
      finance: {
  ...
  it('addAddRecipientEvmScriptFactory works as expected', () => {
    const mockContracts = {
      easyTrack: { addEVMScriptFactory: '0xaddEVMScriptFactory' },
      callsScript: {},
      voting: {},
  ...
  it('addRemoveRecipientEvmScriptFactory works as expected', () => {
    const mockContracts = {
      easyTrack: { addEVMScriptFactory: '0xaddEVMScriptFactory' },
      callsScript: {},
      voting: {},
  ...
  it('adds multiple payment EVM script factories successfully', () => {
    const mockContracts = {
  ...
  it('removes multiple payment EVM script factories successfully', () => {
    const mockContracts = {
