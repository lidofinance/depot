...
import { BaseContract, ContractTransactionResponse, FunctionFragment, Signer } from 'ethers'
...
describe('lifecycle functions', () => {
  ...
  const callReturn = new ContractEvmCall({} as BaseContract, {} as FunctionFragment, [] as any[])
